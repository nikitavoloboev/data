...
- Twitter/Reddit/Instagram/GitHub, get literal name if available. On Twitter, [lowercasing](https://twitter.com/webkit) is often best as Twitter will showcase the custom title on top. Although if name includes many words [capitalizing](https://twitter.com/khanacademyeng) can look better for recognition. Capitalize [Reddit](https://www.reddit.com/r/ApolloApp/) name as it stands out better on searches (the name can't be changed later so capitalize). GitHub is good [lowercased](https://github.com/learn-anything), literal name or with dashes. If name is taken, can add \_ or [HQ](https://twitter.com/SlackHQ)/[App](https://twitter.com/SparkMailApp) in the end. For Instagram, if literal name is taken, it's possible to get domain name literal like [narative.co](https://www.instagram.com/narative.co/). Can use [namecheckr](https://www.namecheckr.com/) to check for available names.
