...
- Twitter/Reddit/Instagram/GitHub, get literal name if available. On Twitter, [lowercasing](https://twitter.com/webkit) is good if one or two words. Otherwise if many words [capitalizing](https://twitter.com/GoogleAI) maybe better for readability. Capitalize [Reddit](https://www.reddit.com/r/ApolloApp/) name as it looks better on searches. GitHub [lowercased](https://github.com/learn-anything), literal name or with dashes. If name taken, can add \_ or [HQ](https://twitter.com/SlackHQ)/[App](https://twitter.com/SparkMailApp) in the end. For Instagram, if literal name is taken, it's possible to get domain name literal like [narative.co](https://www.instagram.com/narative.co/). Can use [namecheckr](https://www.namecheckr.com/) to check for available names.
