...
- Don't listen to distracting music & block out environment noise when focusing. Use [Noizio](http://noiz.io) or [Dark Noise](https://darknoise.app) and listen to wind/rain or similar sounds.
...
- Listen to podcasts/books at fastest speed I can comprehend. (Podcasts: ~ 2/2.5x + smart speed, Books: 1.5/1.75x).
