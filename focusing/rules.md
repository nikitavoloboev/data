...
- Don't listen to distracting music or sounds when trying to focus. Instead use [Noizio](http://noiz.io) or [Oak](https://www.oakmeditation.com) and listen to Wind, Fire or similar sounds. Or have nothing playing at all.
...
- Watch videos (talks & tutorials) in 1.75 or 2x speed, unless it hurts comprehension.
- Listen to podcasts (1.7x + smart speed). Audiobooks (1.75x Audible & 1.5x Books).
...
- Have same profile picture across all social networks for consistency.
...
- Use mnemonic names for aliases/functions.
