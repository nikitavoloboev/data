...
As far as tech goes, my current obsessions, [goals](https://wiki.nikiv.dev/focusing/goals) and [ideas](https://wiki.nikiv.dev/ideas/) for how to live a [better future](https://wiki.nikiv.dev/future/) are [learning](https://wiki.nikiv.dev/education/learning) more of [Solid](https://wiki.nikiv.dev/programming-languages/javascript/js-libraries/solid)/[Svelte](https://wiki.nikiv.dev/programming-languages/javascript/js-libraries/svelte) and [Go](https://wiki.nikiv.dev/programming-languages/go/)/[Swift](https://wiki.nikiv.dev/programming-languages/swift/) to build [amazing experiences](https://wiki.nikiv.dev/design/design-inspiration).
