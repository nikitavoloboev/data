...
Use this editor in addition to [VS Code](../vs-code/vs-code.md) and [Neovim](../vim/vim.md) for its fast speed of opening files.

I use it primarily to edit markdown files like [this wiki](../../other/wiki-workflow.md). Or as a quick scratchpad to write things in.

I use [many plugins](sublime-text-plugins.md) together with [Ayu theme](https://github.com/dempfi/ayu). Most useful being the [vim plugin](https://github.com/guillermooo/Six). 
