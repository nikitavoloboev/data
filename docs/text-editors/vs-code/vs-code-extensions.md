...
- [Infinite Workspace](https://github.com/anas-araid/vscode-infinite-workspace) - Figma-like VSCode infinite workspace.
...
- [VS Code Open in GitHub Button](https://github.com/antfu/vscode-open-in-github-button)
