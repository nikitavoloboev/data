...
- [OpenAI Whisper](https://github.com/openai/whisper) - General-purpose speech recognition. Approaches human level robustness and accuracy on English speech recognition. ([Web](https://openai.com/blog/whisper/))
