...
- [Loxilb](https://github.com/loxilb-io/loxilb) - eBPF based cloud-native service load-balancer. Powering K8s|Edge|5G|IoT|XaaS Apps. ([HN](https://news.ycombinator.com/item?id=34900839))
