...
Use [Elk](https://elk.zone/) as my Mastodon client mostly to read [Merveilles local instance](https://elk.zone/merveilles.town/public/local). Zen mode in Elk is gorgeous. UI only shows when you hover over it, otherwise you just see the toots. [Elk's code](https://github.com/elk-zone/elk) is great to study for how to build nice web apps.
