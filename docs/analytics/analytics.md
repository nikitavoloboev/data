...
- [PoeticMetric](https://github.com/th0th/poeticmetric) - Privacy-focused, open source, and blazingly fast alternative to Google Analytics. ([Reddit](https://www.reddit.com/r/golang/comments/11zfd9f/free_as_in_freedom_open_source_google_analytics/))
