...
The _flow_ state is different for all people. For myself I try to define it clearly. I also try to define a certain set of [rules](./Rules.md) or [workflows](./flow-processes.md) that I like myself to follow for doing certain things.
