...
## Thoughts
- I am thinking how I can experiment with this monthly overview more. Aside from `Changes` and the `Summary` paragraph at the end of each month, I want to drop down some `thoughts` I have too in some form. Just for prosterity. Plus I really do want to write more often, I think it's better to focus on that more rather than just dropping some random thoughts here.
...
- (21) It's pretty amazing how freeing having this kind of `change log` is. It's so awesome that I can quickly open it in a mere second and add a little thing I made or done and have a way to to quickly reference the things I've made in each of the months. I think this will make for a pretty interesting `2018 in review` post.
