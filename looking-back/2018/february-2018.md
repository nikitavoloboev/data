...
- (21) Will try to write more in my digital private journal. I wrote a small letter to myself in there. To remind myself of what it is that I want to do and what I want to __stop doing__. I am not following [my own rules](../../sharing/rules.md)!
...
- In other news though, I think this month, I really am starting to realise more just how absurd my past behaviours were in regards to my life and education. I really want to make cool stuff and I deeply felt that everything around me was limiting me in some way but I should treat it differently. I should embrace everything as a learning opportunity and take the best from the cards I have been dealt just like my [lessons learned](../../knowledge/lessons-learned.md) state. But above all I should just take small steps every day to achieve my goals and not live in some fantasy or fantasies. Just make things I want to make and see what comes out of it.
...
- (22) Trying to make my writing more consistent. Specifically when to __bold__ out text. When to _italicise_ it and when to make a `code quote` of it. Made a rule of it in [rules](../../sharing/rules.md) but it really irks me that I never really had a consistent rule that I followed, I mostly made a `code quote` of everything.
...
- (23) My life would be so much more simpler and nicer if only I followed my own [rules](../../sharing/rules.md) and remembered my own [lessons](../../knowledge/lessons-learned.md). I've been thinking how awesome it would be to have a kind of life linter. That is enforced by my own rules I set. That reminds me when I am doing something that I promised myself not to do. How awesome would that be? Is that even possible?
