...
In short though, I want to take this idea of __sharing everything__ much more seriously in 2018. Sharing things I know continuously in this [wiki](https://wiki.nikitavoloboev.xyz). Sharing some direct pieces of things I know through [my Articles](https://medium.com/@NikitaVoloboev). Making more [YouTube videos](https://www.youtube.com/channel/UCEKqrUfr_FMKIO9XSJS4vDw) and even [streaming myself](https://www.twitch.tv/niikivi) doing and coding things. But more importantly I want to build tools that empower people to do more things.
...
## Wrapping up 2017
All in all it was an amazing year filled with experiences and unforgettable moments. There were [many lessons learned](../../knowledge/lessons-learned.md). And I have a plan going forward in how I want to do things and how [I want to approach life in general](https://www.youtube.com/watch?v=Hygj2wRODCE "Take it easy, dude, but take it!").
