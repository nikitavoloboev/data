...
[Alloy](https://github.com/s1ddok/Alloy) look neat. Will try it out.

[Spotify](https://open.spotify.com/track/3NlJO0Tf9FLjUTHepZgxYf?si=19ufLOQhRjC4Dh_T3LP-zg) never disappoints. The bind from [Alfred Spotify Player](https://alfred-spotify-mini-player.com/) to create a playlist from currently playing song is magical. Can cycle through different genres and feels with ease.

Shame that such a thing doesn't exist for websites at large. Be on a page, press a button and 'show more like that'.

It's an interesting case though that I hope I can solve with Learn Anything and it's database of interlinked & tagged sites. I suppose you can do it already perhaps with Pinboard. Query Pinboard for a website, find the most common tag for the URL & get another link from that tag. But I doubt that it will be possible API wise now as Pinboard isn't thinking about this use case. Nor will it be 'smart'.
